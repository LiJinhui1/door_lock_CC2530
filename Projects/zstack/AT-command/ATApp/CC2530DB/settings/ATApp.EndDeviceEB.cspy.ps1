...
{
& "F:\IAR_8051\common\bin\cspybat" -f "D:\A_proj\A_Cproj\Zigbee\ZigBee-DoorLock-2021.09.27\Projects\zstack\AT-command\ATApp\CC2530DB\settings\ATApp.EndDeviceEB.general.xcl" --debug_file=$debugfile --backend -f "D:\A_proj\A_Cproj\Zigbee\ZigBee-DoorLock-2021.09.27\Projects\zstack\AT-command\ATApp\CC2530DB\settings\ATApp.EndDeviceEB.driver.xcl" 
}
