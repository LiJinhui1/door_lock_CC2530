...
#define COMMAND_CLOSURES_SET_TEMPORARY_PIN                 0x1A
#define COMMAND_CLOSURES_MODIFY_PIN                        0x1B
...
#define COMMAND_CLOSURES_MODIFY_PIN_RSP                    0x1B   
...
#define OPERATION_EVENT_CODE_FORCE_PRY_LOCK                     0x21 // Applicable: INDETERMINATE // customized
#define OPERATION_EVENT_CODE_ENTER_LOCKED_STATE                 0x22 // Applicable: INDETERMINATE // customized
#define OPERATION_EVENT_CODE_LOW_POWER                          0x23 // Applicable: INDETERMINATE // customized
#define OPERATION_EVENT_CODE_DOORBELL                           0x24 // Applicable: INDETERMINATE // customized
#define OPERATION_EVENT_CODE_EXIT_LOCKED_STATE                  0x25 // Applicable: INDETERMINATE // customized
#define OPERATION_EVENT_CODE_WAKE_UP                            0x26 // Applicable: INDETERMINATE // customized
...
#define PROGRAMMING_EVENT_CODE_FINGERPRINT_ADDED                0x07 // Applicable: RFID
#define PROGRAMMING_EVENT_CODE_FINGERPRINT_DELETED              0x08 // Applicable: RFID
#define PROGRAMMING_EVENT_CODE_PIN_TEMPORARY                    0x09
#define PROGRAMMING_EVENT_CODE_PIN_MODIFY                       0x0A
...
// Server Commands Received: Set Temporary Pin
typedef struct
{
  uint8 *adminPin; // variable length string
  uint8 *tempPin; // variable length string
  uint8 activeTimes;
  uint32 activeTime; // in seconds
...
typedef struct
{
  uint8 OriginalPin[12];
  uint8 ModifyPin[12];
} zclDoorLockModifyPin_t;
...
//This callback is called to process an incoming Add Temporary Pin command
typedef ZStatus_t (*zclClosures_DoorLockSetTemporaryPin_t) ( zclIncoming_t *pInMsg, zclDoorLockSetTemporaryPin_t *pCmd );

//This callback is called to process an incoming Modify Pin command
typedef ZStatus_t (*zclClosures_DoorLockModifyPin_t) ( zclIncoming_t *pInMsg, zclDoorLockModifyPin_t *pCmd );
...
typedef struct
{
  ...
  zclClosures_DoorLockSetTemporaryPin_t                         pfnDoorLockSetTemporaryPin;
  zclClosures_DoorLockModifyPin_t                               pfnDoorLockModifyPin;  
...
extern ZStatus_t zclClosures_SendDoorLockGetRFIDCodeResponse( uint8 srcEP, afAddrType_t *dstAddr,
                                                              ...
                                                              uint8 disableDefaultRsp, uint8 seqNum );
extern ZStatus_t zclClosures_SendSetTemporaryPinStatusResponse( uint8 srcEP, afAddrType_t *dstAddr,
                                                                uint8 status, uint8 disableDefaultRsp, uint8 seqNum );
extern ZStatus_t zclClosures_SendModifyPinStatusResponse( uint8 srcEP, afAddrType_t *dstAddr,
                                                  uint8 status, uint8 disableDefaultRsp, uint8 seqNum );
